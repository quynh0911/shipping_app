...
class AddToMarketStart extends StatelessWidget {
  AddToMarketStart({
    Key? key,
  }) : super(key: key);
...
class AddToMarket extends StatefulWidget {
  AddToMarket({
    Key? key,
  }) : super(key: key);

  @override
  _AddToMarketState createState() => _AddToMarketState();
}

class _AddToMarketState extends State<AddToMarket> {
  String? _value = '';
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              ...
                              child: const Text('Tìm kiếm trong chợ',
                                  style: TextStyle(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              productProvider.addNewProductMarket(
