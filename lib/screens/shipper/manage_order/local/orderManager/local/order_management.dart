...
import 'package:flutter_application/screens/shipper/orders/market_bill/main_market_bill.dart';
import 'package:flutter_application/screens/shipper/see_Address/local/see_address.dart';
...
class _ManagementState extends State<Management> {
  ...
  void watch() {
    Navigator.push(
        context, MaterialPageRoute(builder: (_) => StateSeeAddress()));
  }
            ...
            InkWell(
                    ...
                    Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          for (var item in listProduct)
                            if (item.id == listItem.first.id)
                              buildProduct(context, item, true),*/
                            ],
                          ),
                        )),
                    Spacer(),
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => MainMarketBill()));
              },
            ),
            InkWell(
              child: Container(
